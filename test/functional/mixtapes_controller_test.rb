...
class MixtapesControllerTest < ActionController::TestCase
  ...
  test "should create mixtape" do
    assert_difference('Mixtape.count') do
      post :create, mixtape: { dateAdded: @mixtape.dateAdded, downloads: @mixtape.downloads, link: @mixtape.link, name: @mixtape.name }
    end
  ...
  test "should update mixtape" do
    put :update, id: @mixtape, mixtape: { dateAdded: @mixtape.dateAdded, downloads: @mixtape.downloads, link: @mixtape.link, name: @mixtape.name }
    assert_redirected_to mixtape_path(assigns(:mixtape))
  end
